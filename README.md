...
Бот для автоматического извлечения контента из веб-страниц и преобразования в markdown файлы с поддержкой параллелизма, локализации и безопасного webhook режима.
